        ...
        <AppShell>
            ...
            >
                ...
                >
                    ...
                    >
                    {
                        countries.sort((a,b) => a.name > b.name).map((country, index) => (
                ...
                >
                    ...
                    >
                    {
                        teams.sort((a, b) => a.name > b.name).map((team, index) => (
                            <Select.Option key={index} value={team.id}>{team.name}</Select.Option>
                        ))
                    }
                    </Select>
                </Form.Item>
